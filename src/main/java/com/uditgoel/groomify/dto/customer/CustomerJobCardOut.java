...
import com.uditgoel.groomify.dao.PaymentModes;
...
public class CustomerJobCardOut {
	...
	public CustomerJobCardOut() {super();}
	
	public CustomerJobCardOut(String jobCardId, JobStatus jobCardStatus,
			Date jobStartTime, Date jobEndTime, PaymentModes paymentMode,
			Long paymentAmount,
