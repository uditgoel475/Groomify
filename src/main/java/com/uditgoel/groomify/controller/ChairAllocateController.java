...
public class ChairAllocateController {
	...
	private final ChairAllocateFacade chairAllocateFacade;

	public ChairAllocateController(ChairAllocateFacade chairAllocateFacade) {
		this.chairAllocateFacade = chairAllocateFacade;
	}
