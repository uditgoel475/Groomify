...
public class CustomerJobCardDetailsOut {
	...
	public CustomerJobCardDetailsOut(String subJobCardId, JobStatus subJobStatus, EmployeeDTO employeeDTO,
			String serviceName, String customerFeedback, Date jobStartTime, Date jobEndTime) {
		super();
